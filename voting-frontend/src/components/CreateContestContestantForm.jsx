...
const CreateContestContestantForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const contestRes = await fetch("http://localhost:8000/api/contest-contestants/contests", {
        method: "POST",
      ...
      const contestant1Res = await fetch("http://localhost:8000/api/contest-contestants/contestants", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      await fetch("http://localhost:8000/api/contest-contestants/contest-contestants", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ contestId, contestantId: contestant1Data.id, isSuperJoker: false }),
      });

      const contestant2Res = await fetch("http://localhost:8000/api/contest-contestants/contestants", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      <div className="container my-4">
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <button type="submit" className="btn btn-custom btn-lg">Submeter concurso</button>
          </div>
        </form>
      </div>
    </Layout>
